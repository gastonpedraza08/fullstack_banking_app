...
import { initiateAddAccontDetails } from '../actions/account';
...
const Summary = (props) => {
  ...
  const handleAddAccount = (account) => {
    ...
    props.dispatch(initiateAddAccontDetails(account_nro, bank_name, ifsc));
  };
          ...
          {isDownloading ? (
            ...
            <React.Fragment>
              <div className="main-info">
                <p>Account number: {account_nro}</p>
              ...
              <Button
                ...
                type="button"
                onClick={() =>
                  handleDownloadReport(account.id, startDate, endDate)
                }
              >
                Download Report
              </Button>
